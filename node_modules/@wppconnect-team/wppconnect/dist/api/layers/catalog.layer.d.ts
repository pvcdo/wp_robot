...
export declare class CatalogLayer extends HostLayer {
    page: Page;
     ...
     */
    getProductById(id: string, productId: string): Promise<import("@wppconnect/wa-js/dist/whatsapp").ProductModel>;
    /**
