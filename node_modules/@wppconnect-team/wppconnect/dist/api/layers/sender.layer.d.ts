...
export declare class SenderLayer extends ListenerLayer {
     ...
     * @param quotedMessageId Quoted message id
     */
    sendPttFromBase64(to: string, base64: string, filename: string, caption?: string, quotedMessageId?: string): Promise<{
        ack: number;
        id: string;
        sendMsgResult: import("@wppconnect/wa-js/dist/whatsapp/enums").SendMsgResult;
    }>;
     ...
     * @param quotedMessageId Quoted message id
     */
    sendPtt(to: string, filePath: string, filename?: string, caption?: string, quotedMessageId?: string): Promise<unknown>;
    /**
     * Sends file
     * base64 parameter should have mime type already defined
     *
     ...
     * @category Chat
     */
    sendListMessage(to: string, options: ListMessageOptions): Promise<void>;
    /**
