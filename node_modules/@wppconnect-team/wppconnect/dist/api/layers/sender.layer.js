...
var SenderLayer = /** @class */ (function (_super) {
     ...
     * @param quotedMessageId Quoted message id
     */
    SenderLayer.prototype.sendPttFromBase64 = function (to, base64, filename, caption, quotedMessageId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @param quotedMessageId Quoted message id
     */
    SenderLayer.prototype.sendPtt = function (to, filePath, filename, caption, quotedMessageId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    return [2 /*return*/, this.sendPttFromBase64(to, base64, filename, caption, quotedMessageId)
                                            .then(resolve)
                                            .catch(reject)];
                            }
                        });
