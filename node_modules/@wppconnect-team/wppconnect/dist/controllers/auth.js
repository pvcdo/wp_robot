...
var isAuthenticated = function (waPage) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, waPage.evaluate(function () { return WAPI.isRegistered(); })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
function injectSessionToken(page, token, clear) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!token || !(0, token_store_1.isValidSessionToken)(token)) {
                        token = {};
                    }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, page.goto(puppeteer_config_1.puppeteerConfig.whatsappUrl + '?_=' + Date.now())];
                case 2:
                    _a.sent();
                    if (!clear) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(token.WASecretBundle !== 'MultiDevice')) return [3 /*break*/, 7];
                    return [4 /*yield*/, page.evaluate(function (session) {
