...
export declare function initWhatsapp(page: Page, token?: SessionToken, clear?: boolean, version?: string, log?: (level: LogLevel, message: string, meta?: object) => any): Promise<Page>;
